...
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Table d honneur','http://www.caboucadin.com/coloriage/albums/animaux/animaux-de-la-jungle/girafe/dessin-girafe-10.jpg');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Nepal','https://img.redro.pl/plakaty/field-graphic-black-white-landscape-vertical-sketch-illustration-vector-400-198277024.jpg');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Angleterre','https://media1.chapellerie-traclet.com/22922-large/chapeau-melon-anglais.jpg');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'USA','https://i.pinimg.com/originals/43/bc/e3/43bce3d487f64cfa9a8bff8ac622302d.png');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Russie','https://th.bing.com/th/id/OIP.CGr8c6VwJ_kbmkwfpI4agQAAAA?pid=ImgDet&rs=1');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Chine','574ceda6.jpg (600×696) (centerblog.net)');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Thailande','https://i.pinimg.com/736x/ae/b9/49/aeb9495b8822694296bcc6024ec74f39.jpg');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'Australie','http://www.lesgribouillagesdenico.com/images/dessin-de-kangourou_4.jpg');
insert into wedding_table (id, table_name,image_url ) values (nextval('table_id_seq'),'inde','https://st2.depositphotos.com/1000419/10459/v/950/depositphotos_104596248-stock-illustration-indian-goddess-shakti-sketch-for.jpg');



insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Tourne','Jean',4,4,'tournejean@gmail.fr','Hotel',	1,1,1,3);
insert into guest (id,last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Martin','christelle',1,2,'marinchristelle@gmail.fr','Auberge',1,2,8,3);
insert into guest (id,last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Dupond','charles',2,6,'dupondcharles@gmail.fr','Auberge',2,1,5,3);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Duroc','Anna',4,3,'durocAnna@gmail.fr','Auberge',3,1,2,5);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Sarr','Simon',4,3,'SarrSimon@gmail.fr','Auberge',3,2,6,5);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Diatta','Charles',4,5,'DiattaCharles@gmail.fr','Auberge',4,2,7,9);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Gomis','Gisèle',1,4,'GomisGisèle@gmail.fr','Auberge',5,1,9,9);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Kureem','Laura',4,3,'KureemLaura@gmail.fr','Hotel',6,2,10,4);
insert into guest (id,last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Anselmi','chantal',4,1,'Anselmichantal@gmail.fr','Hotel',2,2,12,2);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Anselmi','Patrique',4,1,'AnselmiPatrique@gmail.fr','Hotel',7,2,12,2);
insert into guest (id, last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Ducroq','Bernard',4,1,'DucroqBernard@gmail.fr','Hotel',2,1,3,2);
insert into guest (id,last_name,first_name,role_id,relation_ship_id, email, accommodation,task_id,bridal_id,gift_id,table_id) values(nextval('guest_id_seq'),'Ducroq','Brigitte',4,1,'DucroqBrigitte@gmail.fr','Hotel',2,1,3,2);
